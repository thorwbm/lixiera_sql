    ...
    BEGIN    
            ...
            IF (@ERRO = '')    
                BEGIN    
                    ...
                    SELECT top 1 cor.co_barra_redacao, cor.data_inicio_correcao, cor.data_termino_correcao, cor.id_correcao,    
                           ...
                           cor.redacao_id    
      from dbo.fn_cor_batimento_gabarito(@ID_CORRETOR1 ,@ID_PROJETO, @REDACAO_ID) as cor     
     ...
     --    cor.redacao_id = @REDACAO_ID    
                    ...
                    update ana set ana.conclusao_analise =     
                         ...
                         when situacao_competencia1 = 2 then 3    
                         when situacao_competencia2 = 2 then 3    
                         when situacao_competencia3 = 2 then 3    
                         when situacao_competencia4 = 2 then 3    
                         when situacao_competencia5 = 2 then 3    
    
                         when  situacao_nota_final = 1 then 2    
                         when situacao_competencia1 = 1 then 1    
                         when situacao_competencia2 = 1 then 1    
                         when situacao_competencia3 = 1 then 1    
                         when situacao_competencia4 = 1 then 1    
                         when situacao_competencia5 = 1 then 1 else 0 end    
