...
SELECT DISTINCT   
	                 ...
	                 JSON_MODIFY(
	                     JSON_MODIFY(
                             JSON_MODIFY(@JSON_AUX,
                                 JSON_MODIFY(
                                     JSON_MODIFY(@JSON_AUX, '$.hierarchy.class.value', ta.usuariosturma), 
                                     '$.hierarchy.class.name', ta.turmanome),
  ...
  FROM TMP_IMP_ALUNO_JARDIM_DANFER   ta JOIN cte_grade gra ON (gra.grade_nome = ta.UsuarioSerie)
...
--   INSERT INTO hierarchy_hierarchy 
 ...
 FROM TMP_IMP_ALUNO_JARDIM_DANFER SAE LEFT JOIN hierarchy_hierarchy HIE ON (SAE.TURMANOME = HIE.NAME AND TYPE = 'CLASS')
