...
IF(EXISTS(SELECT 1 FROM SYS.TABLES WHERE NAME = 'SAE_USUARIO'))
	...
	SELECT distinct usu.[id],usu.[email],usu.[name], usu.extra , data_carga = getdate()
	       INTO SAE_USUARIO
...
IF(EXISTS(SELECT 1 FROM SYS.TABLES WHERE NAME = 'SAE_DADOS_EXPORTACAO'))
	...
	SELECT *, data_carga = getdate() INTO SAE_DADOS_EXPORTACAO FROM SAE_PROVA.EXAMS.DBO.VW_DADOS_EXPORTACAO
--	 CRIAR INDEX
...
IF(EXISTS(SELECT 1 FROM SYS.TABLES WHERE NAME = 'SAE_ITEM_ITEM'))
	...
	SELECT *, data_carga = getdate() INTO SAE_ITEM_ITEM FROM SAE_PROVA.EXAMS.DBO.ITEM_ITEM
	-- CRIAR INDEX
...
IF(EXISTS(SELECT 1 FROM SYS.TABLES WHERE NAME = 'SAE_EXAM_EXAM'))
	...
	SELECT *, data_carga = getdate() INTO SAE_EXAM_EXAM FROM SAE_PROVA.EXAMS.DBO.EXAM_EXAM
	-- CRIAR INDEX
...
IF(EXISTS(SELECT 1 FROM SYS.TABLES WHERE NAME = 'SAE_EXAM_EXAMITEM'))
	...
	SELECT *, data_carga = getdate() INTO SAE_EXAM_EXAMITEM FROM SAE_PROVA.EXAMS.DBO.EXAM_EXAMITEM
	-- CRIAR INDEX
...
IF(EXISTS(SELECT 1 FROM SYS.TABLES WHERE NAME = 'SAE_ITEM_ALTERNATIVE'))
	...
	SELECT *, data_carga = getdate() INTO SAE_ITEM_ALTERNATIVE FROM SAE_PROVA.EXAMS.DBO.ITEM_ALTERNATIVE
	-- CRIAR INDEX
...
IF(EXISTS(SELECT 1 FROM SYS.TABLES WHERE NAME = 'SAE_APPLICATION_APPLICATION'))
	...
	SELECT *, data_carga = getdate() INTO SAE_APPLICATION_APPLICATION FROM SAE_PROVA.EXAMS.DBO.APPLICATION_APPLICATION
	-- CRIAR INDEX
...
--SET @PARCIAL = GETDATE()
    IF(EXISTS(SELECT 1 FROM SYS.TABLES WHERE NAME = 'SAE_APPLICATION_ANSWER'))
    	...
    	SELECT *, data_carga = getdate() INTO SAE_APPLICATION_ANSWER FROM SAE_PROVA.EXAMS.DBO.APPLICATION_ANSWER
    	-- CRIAR INDEX
...
select count(1) from SAE_APPLICATION_ANSWER