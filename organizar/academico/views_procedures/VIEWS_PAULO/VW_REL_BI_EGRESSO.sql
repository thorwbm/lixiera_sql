...
CREATE OR ALTER view [dbo].[VW_REL_BI_EGRESSO] as     
select CRC.ID AS CURRICULO_ID, CRC.NOME AS CURRICULO_NOME, 
	   ...
	   CRA.DATA_COLACAO_GRAU, CRA.DATA_CONCLUSAO, CRA.DATA_EXPEDICAO_DIPLOMA,
...
group by dsc.curriculo_aluno_id, alu.id, alu.ra, alu.nome, cur.nome, crc.nome, csa.nome, 
	   ...
	   CRA.media_geral_aluno, FMI.NOME,CRA.DATA_COLACAO_GRAU, CRA.DATA_CONCLUSAO, CRA.DATA_EXPEDICAO_DIPLOMA
GO
