...
create or alter procedure [dbo].[SP_PRO_INSERT_DISCIPLINA_ESPECIAL_GENERICO]   
...
----------------------------------------------------------------------  
   select DISTINCT CGD.disciplina_ID  
     from VW_ACD_CURRIULO_CURSO_GRADE_DISCIPLINA CGD JOIN ACADEMICO_TURMA                  TUR ON (TUR.grade_id = CGD.grade_id)  
                                                     join VW_PRO_ALUNO_DISCIPLINA_ENTURMAR ent on (ent.curriculo_aluno_id = @CURRICULO_ALUNO_ID and  
