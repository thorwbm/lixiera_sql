CREATE OR ALTER PROCEDURE SP_PRO_RODAR_SUBTURMA_E_TURMAS_ESPECIAIS @CURRICULO_ID INT AS 
	...
	open CUR_CARGA 
		...
		while @@FETCH_STATUS = 0
			...
			--	exec SP_PRO_CARGA_SUBTURMAS_ALUNO @CURRICULO_ALUNO_ID
	            ...
	            exec SP_PRO_INSERT_DISCIPLINA_ESPECIAL_GENERICO @CURRICULO_ALUNO_ID, 'Integração Curricular', @TURMA_NOME
	
	            exec SP_PRO_INSERT_DISCIPLINA_ESPECIAL_GENERICO @CURRICULO_ALUNO_ID, 'Treinamento de Habilidade', null
