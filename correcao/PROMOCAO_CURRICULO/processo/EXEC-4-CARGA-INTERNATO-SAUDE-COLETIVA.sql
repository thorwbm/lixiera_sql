...
select distinct 
       ...
       EST.TURMA_DISCIPLINA_ID, DAG.TDA_CURRICULO_ALUNO_ID AS CURRICULO_ALUNO_ID, DAG.ALUNO_ID
into #temp_insert
from vw_curriculo_curso_turma_disciplina_aluno_grade dag
                              join VW_PRO_CURRICULO_TURMA_SAUDE_COLETIVA est on (dag.grade_id = est.GRADE_ID and
...
where dag.status_mat_dis_id = 14 AND 
      EST.curriculo_nome = 'ENFERMAGEM 2016/10-1'  
