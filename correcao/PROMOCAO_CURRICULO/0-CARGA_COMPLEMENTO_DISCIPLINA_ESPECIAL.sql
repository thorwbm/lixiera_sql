	...
	open CUR_ESP 
		...
		while @@FETCH_STATUS = 0
			...
			IF (@VAGA_DISPONIVEL > 0)
				...
				SELECT * FROM #temp_enturmacao TEM WHERE tem.TURMADISCIPLINA_ID = 18830 AND 
						   TEM.CURRICULO_ALUNO_ID = 36025
...
SELECT TOP 100 * FROM vw_curriculo_curso_turma_disciplina_aluno_grade