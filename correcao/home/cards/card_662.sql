...
-- SELECT lan.*
  update lan set lan.status_id = 10, atualizado_em = @DATAEXECUCAO, atualizado_por = 11717
...
WHERE lancamento_responsavel_financeiro_nome = 'prouni' and 
      lan.status_id not in (10,7)

EXEC SP_GERAR_LOG_EM_LOTE_UPDATE 'FINANCEIRO_LANCAMENTO', @DATAEXECUCAO, 11717,null, null,null   


-- select * from FINANCEIRO_LANCAMENTO where atualizado_em >= '2020-05-4 20:55:00' and atualizado_por = 11717
-- commit 
-- rollback 
