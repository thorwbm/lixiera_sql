...
WHERE lancamento_responsavel_financeiro_nome like '%CAIXA ECONOMICA FEDERAL%' and 
      lan.status_id not in (7, 8)

EXEC SP_GERAR_LOG_EM_LOTE_UPDATE 'FINANCEIRO_LANCAMENTO', @DATAEXECUCAO, 11717,null, null,null   


--   select * from FINANCEIRO_LANCAMENTO where atualizado_em >= '2020-05-4 21:03:00' and atualizado_por = 11717
-- commit 
-- rollback 
