...
select distinct
       ...
       aluno_id      = alu.id, criado_por = @USUARIO,   
...
insert into 
       contratos_parcela (criado_em, criado_por, atualizado_em, atualizado_por, descricao, data_vencimento, valor, 
	                      mes_competencia, ano_competencia, contrato_id, tipo_id)  
...
select distinct   
 ...
 where 
       lan.id is null and 
	   prx.boleto_id is not null and 
	   prx.status_parcela = 'PAGO'
 group by   
...
INSERT INTO    
        FINANCEIRO_DESCONTO (criado_em, atualizado_em, criado_por, atualizado_por,
	                         descricao, porcentagem, valor, data_validade, lancamento_id, desconto_contrato_id, tipo_id)  
