with    cte_dados as (
            select distinct 
                   cra.curso_nome, cra.curriculo_nome, cra.curriculo_aluno_status_nome,cra.aluno_ra, cra.aluno_cpf, 
             ...
             where eta.ano = 2019 and 
                   ...
                   cra.forma_ingresso_nome = 'prouni' 
)
    ,   cte_quantidade_aprovacao_ano_periodo as (
            ...
            select dad.curriculo_nome, dad.curso_nome,dad.aluno_nome, dad.forma_ingresso_nome, 
                   dad.aluno_disciplina_status, nota, dad.disciplina_nome, dad.ano, dad.periodo,
...
-- select * from curriculos_gradedisciplina