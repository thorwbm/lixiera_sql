...
select criado_em = getdate(), atualizado_em = getdate(), 
	   ...
	   contrato_id = con.id, criado_por = 2136, tipo_id = 1, atualizado_por = 2136
...
select descricao = 'desconto ' + DES.COMPETENCIA, porcentagem = null, valor = des.valor, parcela_id = par.id, tipo_id = 3,
...
select distinct 
 ...
 where lan.id is null and 
       par.mes_competencia = 1
