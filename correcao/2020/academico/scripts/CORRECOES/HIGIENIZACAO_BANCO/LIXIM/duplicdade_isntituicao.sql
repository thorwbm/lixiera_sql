create procedure sp_corrigir_duplicidade_instituicao @instituticao_nome varchar(max) as 
...
-- SELECT HISTORY_DATE, * FROM LOG_academico_pessoa_titulacao ORDER BY 1 DESC
-- SELECT * FROM #TMP_REMOVER
-- SELECT * FROM core_instituicao WHERE nome = 'ESCOLA ESTADUAL DE 1º E 2º GRAUS GOVERNADOR MILTON CAMPOS 0.5.6.E.'  --21072 , 22851
