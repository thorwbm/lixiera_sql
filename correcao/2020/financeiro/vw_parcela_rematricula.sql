...
/****** Object:  View [dbo].[vw_parcela_rematricula]    Script Date: 04/08/2020 23:25:57 ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 ALTER view [dbo].[vw_parcela_rematricula] as        
...
select ext.id         as extrato_id,          
       mat.student_id collate database_default as RA,         
...
from onboarding_enrollment mat   
                          ...
                          left join onboarding_financeplan                   pla on (pla.id = fin.plan_id)        
						  left join finances_studentstatement                ext on (mat.id = ext.enrollment_id)
