/****** Object:  View [dbo].[vw_relatorio_terceira_correcao_avaliador]    Script Date: 26/11/2019 13:00:59 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
    ...
    case when cor.competencia5 = -1 then 0 else cor.competencia5 end AS terceira_c5,
    ...
    case when cor4.competencia5 = -1 then 0 else cor4.competencia5 end  AS quarta_c5,
